> ### This directory is yours — NNIELSEN_V13
>
...
```44:75:sea_of_colours/orchestrator_2/harnesses/nnielsen_v13/orbit_policy.py
...
```43:43:sea_of_colours/orchestrator_2/harnesses/nnielsen_v13/_v7/chat_schema.py
...
Prefer changing `nnielsen_v13/` proper; touch `_v7/` only for shared
...
| --- | --- | --- |
| `NNIELSEN_V13_SINGLE` | `0` | `1` skips the THINK/PLAN split — one LLM call, faster, dumber |
| `NNIELSEN_V13_AUTOFILL` | `0` | `1` lets the packager top up a short plan |
