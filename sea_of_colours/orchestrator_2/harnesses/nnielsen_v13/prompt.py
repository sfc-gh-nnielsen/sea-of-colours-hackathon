...
from sea_of_colours.orchestrator_2.harnesses.nnielsen_v13._v7.orbit_wishlist import (
    Wishlist,
)
...
from sea_of_colours.orchestrator_2.harnesses.nnielsen_v13._v7.prompt import (
    format_state_block,
