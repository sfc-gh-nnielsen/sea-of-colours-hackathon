> ### This directory is yours — IAKABI_REAPER
>
...
```44:75:sea_of_colours/orchestrator_2/harnesses/iakabi_reaper/orbit_policy.py
...
```43:43:sea_of_colours/orchestrator_2/harnesses/iakabi_reaper/_v7/chat_schema.py
...
Prefer changing `iakabi_reaper/` proper; touch `_v7/` only for shared
...
| --- | --- | --- |
| `IAKABI_REAPER_SINGLE` | `0` | `1` skips the THINK/PLAN split — one LLM call, faster, dumber |
| `IAKABI_REAPER_AUTOFILL` | `0` | `1` lets the packager top up a short plan |
